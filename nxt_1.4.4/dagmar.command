...
#java -Xms128m -Xmx512m -Xbootclasspath/p:$CLASSPATH -Djava.library.path="$FMJHOME" net.sourceforge.nite.nxt.GUI -corpus Data/meta/dagmar-metadata.xml
java -Xms128m -Xmx512m -Djava.library.path="$FMJHOME" net.sourceforge.nite.nxt.GUI -corpus Data/meta/dagmar-metadata.xml
