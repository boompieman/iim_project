...
/**
 * NOMReadTypeElement extends NOMElement and represents an individual
 ...
 *
 * @author jonathan */
public class NOMReadTypeElement extends NOMReadElement implements NOMTypeElement {
    protected NOMReadTypeElement(NOMCorpus corpus, String name, 
    ...
    /** This constructor will be the most commonly used in application
        ...
        loaded. */
    public NOMReadTypeElement(NOMCorpus corpus, String name) throws NOMException {
    ...
    protected NOMReadTypeElement(NOMCorpus corpus, String name, String colour, NResource resource,
    ...
    public NOMReadTypeElement(NOMCorpus corpus, String comment, String colour, NResource resource) 
     throws NOMException {
