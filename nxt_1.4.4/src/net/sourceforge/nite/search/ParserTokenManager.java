...
private final int jjMoveStringLiteralDfa0_0()
{
   switch(curChar)
   {
      ...
      case 60:
         return jjStartNfaWithStates_0(0, 30, 210);
      case 62:
...
private final int jjMoveNfa_0(int startState, int curPos)
{
   ...
   for (;;)
   {
      ...
      if (curChar < 64)
      {
         ...
         MatchLoop: do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 341:
                  if ((0x3ff401000000000L & l) != 0L)
                     jjCheckNAddTwoStates(341, 338);
                  break;
               case 342:
                  if (curChar == 36 && kind > 44)
                     kind = 44;
                  break;
               case 343:
                  if ((0x3ff401000000000L & l) == 0L)
      ...
      ++curPos;
      if ((i = jjnewStateCnt) == (startsAt = 376 - (jjnewStateCnt = startsAt)))
         return curPos;
      try { curChar = input_stream.readChar(); }
...
static final int[] jjnextStates = {
   337, 341, 342, 343, 210, 211, 135, 140, 51, 52, 54, 46, 47, 49, 56, 57, 
   59, 136, 137, 139, 143, 145, 334, 335, 331, 332, 366, 374, 375, 375, 347, 349, 
   353, 356, 291, 300, 301, 308, 271, 282, 253, 266, 245, 249, 207, 208, 204, 205, 
   155, 167, 179, 152, 153, 148, 149, 129, 133, 118, 124, 105, 110, 82, 86, 90, 
   72, 76, 312, 329, 235, 236, 239, 241, 213, 214, 217, 233, 190, 192, 193, 198, 
   202, 181, 183, 188, 95, 99, 341, 338, 
};
...
null, null, null, null, "\176", "\41\176", null, null, null, null, null, null, null, 
null, null, "\136", "\76", "\74", null, null, null, null, null, null, null, null, 
null, null, null, null, null, null, null, null, null, null, "\72\72", "\50", "\54", 
"\51", "\72", };
...
private final int[] jjrounds = new int[376];
private final int[] jjstateSet = new int[752];
