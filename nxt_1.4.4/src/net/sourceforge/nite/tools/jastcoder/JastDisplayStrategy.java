...
@author Craig Nicol, based on NEDisplayStrategy
 
*/
public class JastDisplayStrategy extends AbstractDisplayStrategy {


    /**Documentation as in superclass?**/
    protected final String JAST_STYLE_NAME="JAST_STYLE";
    /**Documentation as in superclass?**/
     ...
     */  
    public JastDisplayStrategy (NTranscriptionView ntv, String neTypeRole, String abbrevAttrib, String attributeName) {
        init(ntv);
        ...
        if (styles != null && styles.size() > 0) {
            ...
            if (style != null) {
                while (it.hasNext()) {
                    ...
                    //ntv.insertCopyOfStyle(next,style,JAST_STYLE_NAME+String.valueOf(idcounter));
    ...
    public void undisplay(NOMElement element) {
        ...
        Predicate isMyTextStyle = new Predicate() {
                public boolean valid(Object o) {
                    return ((Style)o).getName().startsWith(JAST_STYLE_NAME);
                }
            };     
        Iterator it = l.iterator();
        NTextElement next = null;
    ...
    protected List getColouredStyle(NOMElement element) {
        ...
        //System.out.println("JastDS::styles::size() == " + styles.size());
        return styles;
    }
    ...
    protected Style getTemplateStyle(Object type) {
        ...
        if (ontologyToStyle.get(type) == null) {
            ...
            Style newTemplate = ntv.addStyle(JAST_STYLE_NAME+"_template_"+tidString,null);
